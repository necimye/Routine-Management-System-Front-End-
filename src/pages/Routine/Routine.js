			...
			for (var val in routine[name]) {
				for (var start in routine[name][val]) {
					for (
						...
						i <
						parseInt(start) +
							parseInt(routine[name][val][start].noOfPeriod);
						i++
					) {
						// console.log(dummy);
