...
function ProfileCard() {
  ...
  const [subject, setSubject] = useState("Computer Graphics, Artificial Intelligence, Satellite Communication");
  const [username, setUsername] = useState('suraj@61');
  const [email, setEmail] = useState('pokhrelsuraj1211@gmail.com');
  const [about, setAbout] = useState('I am a part time software engineer as well as part time professor at Pulchowk Campus');
